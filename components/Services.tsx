      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <ScrollReveal delay={0} className="text-center mt-14">
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#0a1628] hover:bg-[#112240] text-white font-bold px-8 py-4 rounded-xl text-lg transition-all duration-200 hover:-translate-y-0.5 shadow-lg"
          >
