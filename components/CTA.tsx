          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-2xl">
            {submitted ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-[#0a1628] font-bold text-2xl mb-2">Request Received</h3>
                <p className="text-slate-500">We&apos;ll be in touch within the hour. Talk soon.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      placeholder="John"
                      className="w-full border border-slate-200 rounded-xl px-4 py-3 text-[#0a1628] placeholder-slate-400 focus:outline-none focus:border-[#1e6bff] focus:ring-2 focus:ring-[#1e6bff]/20 transition"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-[#0a1628] mb-1.5">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      required
                      className="w-full border border-slate-200 rounded-xl px-4 py-3 text-[#0a1628] focus:outline-none focus:border-[#1e6bff] focus:ring-2 focus:ring-[#1e6bff]/20 transition bg-white"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-slate-200 rounded-xl px-4 py-3 text-[#0a1628] placeholder-slate-400 focus:outline-none focus:border-[#1e6bff] focus:ring-2 focus:ring-[#1e6bff]/20 transition resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full bg-[#1e6bff] hover:bg-[#1450cc] text-white font-bold py-4 rounded-xl text-lg transition-all duration-200 hover:-translate-y-0.5 shadow-lg shadow-blue-500/25"
                >
